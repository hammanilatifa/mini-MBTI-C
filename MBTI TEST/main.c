...
int main()
{
    int  r; //réponse de l'utilisateur
    ...
    do{
        switch(r){
            ...
            case 2:
                ...
                break ;
            default: //On envoie un message d'erreur au cas où l'utilisateur ne saisit pas une des lettres proposées
                printf("Erreur, veuillez saisir le nombre correspondant a votre reponse \n");
                scanf("%d",&r);}
    }while(r!=1 && r!=2); //Boucle en cas d'erreur
   ...
   //Question 3
    ...
    printf("1: Les faits, les détails et y-aller etape par etape    2: Les concepts, les theories et la vue d'ensemble \n");
    scanf("%d",&r);
    do{
        switch(r){
            case 1:
                CptS=CptS+1 ; //On ajoute un point au compteur "Détécteur"
                break ;
            case 2:
    ...
    printf("1: Tete, raisonnement et logique     2: Cœur, sentiments et emotions \n");
    scanf("%d",&r);
    do{
        switch(r){
            case 1:
    ...
    printf("9- On vous a souvent accusé d'etre: \n"); //Question 9
    ...
    printf("1: non structurees et spontanees   2: Structurées et planifiees \n");
    scanf("%d",&r);
    do{
        switch(r){
            case 1:
